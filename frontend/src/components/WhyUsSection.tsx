...
const features = [
  ...
  },
  {
    icon: "🏆",
    title: "خبرة ١٠+ سنوات",
    desc: "نخبة من أفضل المتخصصين في المملكة",
  },
];

const WhyUsSection = () => {
  return (
    <section className="py-20 bg-white dark:bg-gray-900 transition-colors duration-500 " id="features">
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-[1.6]">
            نحن لا نقدم مجرد جلسات — نقدم تجربة علاجية متكاملة تبدأ من اللحظة التي تحجز فيها.
          </p>
