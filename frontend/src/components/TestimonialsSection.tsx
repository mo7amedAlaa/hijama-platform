...
const testimonials = [
  {
    name: "أحمد السعيد",
    role: "رياضي محترف",
    text: "استشفاء مذهل بعد كل تمرين. لا أتخيل روتيني بدون الجلسات",
    initial: "أ",
  },
  {
    name: "سارة العمري",
...
const TestimonialsSection = () => {
  return (
    <section
      className="py-20 bg-gray-50 dark:bg-gray-950 transition-colors duration-500 "
      id="reviews"
    >
      <div className="container mx-auto px-6">
        {/* HEADER */}
        <div className="text-center mb-12">
          <p className="text-blue-600 font-medium">💬 آراء عملائنا</p>
